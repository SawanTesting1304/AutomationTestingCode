...
public class RRMMS_PositiveFlow extends RRMMS.utility.TestBase {
	...
	@Test(priority = 1)
	public void Prospect() throws Exception {
	...
	@Test(priority = 2)
	public void LeaseAssociation() throws Exception {
	...
	@Test(priority = 3)
	public void ProspectWorkFlow() throws Exception {
		// Prospect Work Flow
	...
	@Test(priority = 4)
	public void AssetWorkFlow() throws Exception {
		...
		Common.loader();
		driver.findElement(
				By.xpath("//div[@id='divViewAsset']/div/div/div/div[1]/a/div/div[2]/div"))
				.click();
		Common.loader();
		// Asset work Flow
	...
	public void DO() throws Exception {
		// Create DO
		CommonAssociation.CreateDO(driver);
